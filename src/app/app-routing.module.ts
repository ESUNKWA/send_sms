...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      {
        path:'default',
        loadChildren:()=> import('./views/apps/default/default.module').then(m => m.DefaultModule)
      },
      {
        path:'send-sms',
        loadChildren:()=> import('./views/apps/send-sms/send-sms.module').then(m => m.SendSmsModule)
      },
      {
        path:'send-one-sms',
        loadChildren:()=> import('./views/apps/send-one-sms/send-one-sms.module').then(m => m.SendOneSmsModule)
      },
      {
        path:'send-many-sms',
        loadChildren:()=> import('./views/apps/send-many-sms/send-many-sms.module').then(m => m.SendManySmsModule)
      },
      {
        path:'balance',
        loadChildren:()=> import('./views/apps/balance/balance.module').then(m => m.BalanceModule)
      },
      /**************************************************************************************************************/
      {
        path: 'dashboard',
